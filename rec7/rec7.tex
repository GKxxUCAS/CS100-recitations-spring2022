...
Point2d p;
    \end{cpp}
    The above code outputs ``\ttt{Point2d(double, double) body}'' first, and then ``\ttt{default ctor body}''.
\end{frame}
...
\begin{frame}{Further Reading}
    \begin{itemize}
        ...
        \begin{itemize}
            \item Read until the \ttt{class Month} example (about two pages). The rest part is not for you now.
        \end{itemize}
